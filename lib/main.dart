...
class _MainAppState extends State<MainApp> {
  ...
  //   Client(),
  //   socketConnector: () {
  //     return IOWebSocketChannel.connect(testWsRpcUrl).cast<String>();
  //   },
  // );
  ...
  //   final t = EthereumAddress.fromHex('0x7D1907ea2AEAb4789eA27ED1154f51cf13ED7bE1');
  ...
  //         [bytesToHex(t.addressBytes, forcePadLength: 64, include0x: true)],
  //       ],
  //     ),
  //   )
  //       .listen((event) {
  //     final t = contract.event('AssetCreated').decodeResults(event.topics!, event.data!);
  //     print(event);
  //   });
  ...
  //   const assetId = 'test_id_2';
  //   const assetLink = 'https://example.com/asset3';
